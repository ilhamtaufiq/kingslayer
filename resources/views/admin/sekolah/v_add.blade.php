            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="posisi" name="posisi" class="form-control" placeholder="Posisi Sekolah">
                    <div class="text-danger">
                        @error('posisi')
                            {{ $message }}
                        @enderror
                ...
                <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi Sekolah">
                    <div class="text-danger">
                        @error('deskripsi')
                            {{ $message }}
                        @enderror
...
var peta4 = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
  ...
  var map = L.map('map', {
   ...
   //mengambil koordinat
   var curLocation = [-6.818103945613233, 107.13639780080835]; 
